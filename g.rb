...
class Player
  ...
  def initialize(window)
    @image = Gosu::Image.new(window, "media/Starfighter2.bmp", false)
...
class Drone3
  ...
  def initialize(window)
    @image = Gosu::Image.new(window, "media/Drone3.bmp", false)
    @color = Gosu::Color.new(0xff000000)
    @color.red = rand(256 - 40) + 40
    @color.green = rand(256 - 40) + 40
    @color.blue = rand(256 - 40) + 40
...
class Drone4
  ...
  def initialize(window)
    @image = Gosu::Image.new(window, "media/Drone4.bmp", false)
    @color = Gosu::Color.new(0xff000000)
    @color.red = rand(256 - 40) + 40
    @color.green = rand(256 - 40) + 40
    @color.blue = rand(256 - 40) + 40
...
class GameWindow < Gosu::Window
  def initialize
    ...
    @background_image = Gosu::Image.new(self, "media/Space3.png", true)
...
#
  ...
  def draw
    totalScore = @drone.score + @drone2.score + @drone3.score + @drone4.score
  	@player.draw
  	@drone.draw
    @drone2.draw
    @drone3.draw
    ...
    @font.draw("      PLAYER : #{@player.score}       DRONES : #{totalScore}            Drone 1 : #{@drone.score}   Drone 2 : #{@drone2.score}   Drone 3 : #{@drone3.score}   Drone 4 : #{@drone4.score}", 10, 10, ZOrder::UI, 1.0, 1.0, 0xffffff00)
